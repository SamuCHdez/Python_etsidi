...
for ConcentracionPrimero in numpy.arange(0,1.25,0.25):
...
#quiero recorrer el dataframe, usando los valores de dd,dp y dh de cada fila (fijo uno y pruebo el resto con el fijado)
#para encontraar la mejor mezcla de disolventes con ese soluto.
